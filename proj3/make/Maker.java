...
class Maker {
    ...
    void readFileAges(String fileInfoName) {
        ...
        try {
            ...
            error("%s doesn't exist", fileInfoName);
        }
    }
        ...
        while (inp.hasNextLine()) {
            ...
            if (parsed.matches()) {
                ...
                if (!parsed.group(2).isEmpty()) {
                    for (String dep : SPACES.split(parsed.group(2))) {
     ...
     * @return Rule for making target
     * @param target String name of rule
     */
